...
@if($feature('module_restaurant'))
    ...
    @if($isAdmin || $can('restaurant.view') || $can('restaurant.orders') || $can('restaurant.menu') || $can('restaurant.tables'))
        ...
        @if($isAdmin || $can('restaurant.counter') || $can('restaurant.orders') || $can('restaurant.view'))
    ...
    @if($isAdmin || $can('restaurant.reports') || $can('restaurant.view') || $can('restaurant.orders'))
