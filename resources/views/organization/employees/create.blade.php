...
<div class="max-w-4xl mx-auto px-4 py-2">
    ...
    <!-- Form Container -->
    <form action="{{ route('organization.employees.store') }}" method="POST" class="bg-white rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/40 overflow-hidden">
        @csrf
        ...
        <div class="p-6 md:p-8 space-y-6">
            <div class="flex items-center gap-3 pb-3 border-b border-slate-100">
                <div class="w-8 h-8 rounded-lg bg-amber-50 text-amber-500 flex items-center justify-center font-bold">1</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="first_name" value="{{ old('first_name') }}" required class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('first_name') border-red-300 bg-red-50 @enderror" placeholder="e.g. John">
                ...
                <div>
                    ...
                    <input type="text" name="last_name" value="{{ old('last_name') }}" class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('last_name') border-red-300 bg-red-50 @enderror" placeholder="e.g. Doe">
                ...
                <div>
                    ...
                    <input type="text" name="employee_code" value="{{ old('employee_code') }}" class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('employee_code') border-red-300 bg-red-50 @enderror" placeholder="e.g. EMP-101">
                ...
                <div>
                    ...
                    <input type="text" name="designation" value="{{ old('designation') }}" class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('designation') border-red-300 bg-red-50 @enderror" placeholder="e.g. Manager">
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('phone') border-red-300 bg-red-50 @enderror" placeholder="e.g. +91 98765 43210">
                ...
                <div>
                    ...
                    <input type="date" name="joining_date" value="{{ old('joining_date') }}" class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('joining_date') border-red-300 bg-red-50 @enderror">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="2" class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('address') border-red-300 bg-red-50 @enderror" placeholder="e.g. Flat 101, Main Road, New Delhi">{{ old('address') }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('email') border-red-300 bg-red-50 @enderror" placeholder="e.g. employee@company.com">
        ...
        <div class="border-t border-slate-200 p-6 md:p-8 space-y-6 bg-slate-50/30">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 border-b border-slate-200">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-indigo-50 text-indigo-500 flex items-center justify-center font-bold">2</div>
                    <h2 class="text-sm font-bold text-slate-800 uppercase tracking-widest">System Login Access</h2>
                </div>
                
                <!-- Toggle Switch styling -->
                <label class="switch-toggle bg-white px-3 py-2 rounded-xl border border-slate-200 shadow-sm cursor-pointer hover:border-amber-400 transition-colors">
                    <input type="checkbox" name="create_account" id="createAccountToggle" value="1" {{ old('create_account') ? 'checked' : '' }}>
                    <div class="switch-slider"></div>
                    <span class="ml-2.5 text-xs font-bold text-slate-700">Create Login Credentials</span>
                </label>
            </div>
            
            <div id="accountFields" class="{{ old('create_account') ? '' : 'hidden' }} space-y-4 mt-2">
                <div class="bg-indigo-50/50 border border-indigo-100 p-4 rounded-xl flex items-start gap-3">
                    ...
                    <p class="text-xs text-indigo-800 font-medium leading-relaxed">
                        Enabling this will create a user account for the employee. The <span class="font-bold">Contact Email</span> entered above will be used as their login username.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="role" id="accRole" class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 rounded-xl px-4 py-2.5 text-sm font-medium outline-none transition-all shadow-sm @error('role') border-red-300 bg-red-50 @enderror">
        ...
        <div class="bg-slate-50 border-t border-slate-200 px-6 py-4 flex flex-col-reverse sm:flex-row justify-end gap-3">
            ...
            <button type="submit" class="px-6 py-2.5 bg-slate-900 text-white rounded-xl font-bold text-xs hover:bg-slate-800 shadow-sm transition-all flex items-center justify-center gap-2">
