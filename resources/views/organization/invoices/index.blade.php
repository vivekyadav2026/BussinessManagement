      ...
      <tr class="hover:bg-gray-50/50 transition-colors">
        ...
        <td class="py-4 px-4 text-right">
            <div class="inline-flex gap-2">
                ...
                <a href="{{ route('organization.invoices.print', $inv) }}" target="_blank" class="p-1 text-gray-400 hover:text-green-600 hover:bg-gray-100 rounded-lg transition-colors" title="Print A4 Invoice">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
                </a>
                <a href="{{ route('organization.invoices.receipt', $inv) }}" target="_blank" class="p-1 text-gray-400 hover:text-indigo-600 hover:bg-gray-100 rounded-lg transition-colors" title="Print Thermal Receipt (Small Machine)">
